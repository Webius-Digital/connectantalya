                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12">
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="flex items-center space-x-8">
                                <div className="font-bold text-xl tracking-widest opacity-80 decoration-primary underline decoration-2 underline-offset-8">LTC MEDIA</div>
                                <div className="font-bold text-xl tracking-widest opacity-80 decoration-secondary underline decoration-2 underline-offset-8">MS TOURISM</div>
                            </div>
                        </div>
